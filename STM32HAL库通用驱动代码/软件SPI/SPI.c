...
{
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, BitValue);		//根据BitValue，设置SS引脚的电平
}
...
{
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_13, BitValue);		//根据BitValue，设置SCK引脚的电平
}
...
{
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_15, BitValue);		//根据BitValue，设置MOSI引脚的电平，BitValue要实现非0即1的特性
}
...
{
	return HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_14);			//读取MISO电平并返回
}
